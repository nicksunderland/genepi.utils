...
Here is a simple example of using the `miami()` plot function. The use of named lists for the parameters is not strictly necessary, but helps readability. 
...
p <- miami(gwases         = list("top"=gwas_top, "bottom"=gwas_bottom),
           ...
           y_limits       = list("top"=c(0, 9), "bottom"=c(0, 9)),
           downsample     = 0.0, 
           hit_table      = TRUE,
           title          = "Miami Plot",
