...
A common reference dataset is the 1000 genomes phase 3 which can be downloaded from the PLINK [website](https://www.cog-genomics.org/plink/2.0/resources#phase3_1kg). **Important**: if you use a different dataset ensure that the IDs match those in your dataset). 
...
clumped_gwas <- clump(gwas, 
                      ...
                      kb = 250, 
                      plink2    = which_plink2(), 
                      plink_ref = which_1000G_reference())
