...
#
#   # data
#   map   <- list(rsid="MARKER", chr="CHR", bp="POS", beta="BETA", se="SE", p="P", eaf="EAF", ea="A1", oa="A2")
#   gwas1 <- GWAS(dat=system.file("extdata", "example2_gwas_sumstats.tsv", package="genepi.utils"), map=map)
#   gwas1 <- as.data.table(gwas1)
#   gwas2 <- GWAS(dat=system.file("extdata", "example2_gwas_sumstats.tsv", package="genepi.utils"), map=map)
